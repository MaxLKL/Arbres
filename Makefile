...
$(EXEC): main.o fonctions_base.o generation_rnd.o affichage.o graphics.o centre_files.o
	$(CC) $^ -o $(EXEC) $(CFLAGS) `sdl-config --libs` -lSDL_ttf -lm


main.o: centre_files.h affichage.h fonctions_base.h types.h generation_rnd.h graphics.h 
centre_files.o: types.h
